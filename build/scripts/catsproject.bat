...
@rem ##########################################################################
@rem
@rem  catsproject startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and CATSPROJECT_OPTS to pass JVM options to this script.
...
@rem Execute catsproject
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CATSPROJECT_OPTS%  -classpath "%CLASSPATH%" pl.amu.service.UsersApplication %CMD_LINE_ARGS%
...
:fail
rem Set variable CATSPROJECT_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CATSPROJECT_EXIT_CONSOLE%" exit 1
exit /b 1
